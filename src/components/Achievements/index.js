          ...
          <form>
            ...
            <div className={styles.radios}>
              <div className={styles.radio}>
                <input type='radio' name='achievement' value='Speeltijd' id='speeltijd'/>
                <label htmlFor='speeltijd'>Speeltijd</label>
              </div>
              <div className={styles.radio}>
                <input type='radio' name='achievement' value='Munten' id='munten'/>
                <label htmlFor='munten'>Munten</label>
              </div>
              <div className={styles.radio}>
                <input type='radio' name='achievement' value='Behaalde Achievements' id='achievement'/>
                <label htmlFor='achievement'>Behaalde Achievements</label>
              </div>
              <div className={styles.radio}>
                <input type='radio' name='achievement' value='Jumps' id='jumps'/>
                <label htmlFor='jumps'>Jumps</label>
              </div>
              <div className={styles.radio}>
                <input type='radio' name='achievement' value='Afstand in KM' id='distance'/>
                <label htmlFor='distance'>Afstand in KM</label>
              </div>
              <div className={styles.radio}>
                <input type='radio' name='achievement' value='Spierspanning' id='spanning'/>
                <label htmlFor='spanning'>Spierspanning</label>
              </div>
            </div>
            <p>Waarde</p>
            <input className={styles.value} type='text' name='value' id='value'/>
